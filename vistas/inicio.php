    ...
    <div class="owl-carousel owl-banner">
      <div class="item item-1">
        <div class="header-text">
          <span class="category">Antioquia, <em>Itagui</em></span>
          <h2>¡Apurarse!<br>Consigue la mejor para ti</h2>
        </div>
      </div>
      <div class="item item-2">
        <div class="header-text">
          <span class="category">Antioquia, <em>Medellin</em></span>
          <h2>¡Sé rápido!<br>Consigue la mejor casa de la ciudad</h2>
        </div>
      </div>
      <div class="item item-3">
        <div class="header-text">
          <span class="category">Antioquia, <em>Envigado</em></span>
          <h2>¡Actuar ahora!<br>Consigue el ático de más alto nivel</h2>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="left-image">
            ...
            <a href="index.php?enviar=detalles"><img src="assets/images/featured-icon.png" alt="" style="max-width: 60px; padding: 0px;"></a>
          </div>
        </div>
        <div class="col-lg-5">
          <div class="section-heading">
            <h6>| presentado</h6>
            <h2>Mejor apartamento &amp; vista</h2>
          </div>
          <div class="accordion" id="accordionExample">
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                ¿Los mejores enlaces útiles?
                </button>
              </h2>
              <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                consigue <strong>la mejor casa</strong> Plantilla de sitio web en HTML CSS y Bootstrap para su negocio. TemplateMo te proporciona la <a href="https://www.google.com/search?q=best+free+css+templates" target="_blank">las mejores plantillas CSS gratuitas</a> en el mundo. Por favor cuéntaselo a tus amigos.</div>
              </div>
            </div>
            <div class="accordion-item">
            ...
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingThree">
                ...
                ¿Por qué grupo exito es el mejor?
                </button>
              </h2>
          ...
          <div class="info-table">
            <ul>
              <li>
                ...
                <h4>250 m2<br><span>Espacio plano total</span></h4>
              </li>
              <li>
                <img src="assets/images/info-icon-02.png" alt="" style="max-width: 52px;">
                <h4>Contrato<br><span>Listo para el contrato</span></h4>
              </li>
              <li>
                <img src="assets/images/info-icon-03.png" alt="" style="max-width: 52px;">
                <h4>Pago<br><span>Proceso de pago</span></h4>
              </li>
              <li>
      ...
      <div class="row">
        <div class="col-lg-4 offset-lg-4">
          <div class="section-heading text-center">
            <h6>| Video View</h6>
            <h2>Obtenga una visión más cercana y una sensación diferente</h2>
          </div>
        </div>
      </div>
    </div>
              ...
              <div class="col-lg-4">
                <div class="counter">
                  <h2 class="timer count-title count-number" data-to="34" data-speed="1000"></h2>
                   <p class="count-text ">Edificios<br>Termino ahora</p>
                </div>
              </div>
              <div class="col-lg-4">
                <div class="counter">
                  <h2 class="timer count-title count-number" data-to="12" data-speed="1000"></h2>
                  <p class="count-text ">Años<br>Experiencia</p>
                </div>
              </div>
              <div class="col-lg-4">
                <div class="counter">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4">
          <div class="section-heading">
            <h6>| mejor trato</h6>
            <h2>¡Encuentre su mejor oferta ahora mismo!</h2>
          </div>
        </div>
        <div class="col-lg-12">
                ...
                <div class="tab-pane fade show active" id="appartment" role="tabpanel" aria-labelledby="appartment-tab">
                  <div class="row">
                    <div class="col-lg-3">
                      <div class="info-table">
                        <ul>
                          <li>Espacio plano total <span>185 m2</span></li>
                          <li>Numero de piso <span>26th</span></li>
                          <li>Número de habitaciones <span>4</span></li>
                          <li>Estacionamiento disponible <span>si</span></li>
                    ...
                    <div class="col-lg-3">
                      ...
                      <div class="icon-button">
                        <a href="index.php?enviar=detalles"><i class="fa fa-calendar"></i> Schedule a visit</a>
                      </div>
                    </div>
                  </div>
                </div>
  ...
  <div class="properties section">
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="item">
            <a href="index.php?enviar=detalles"><img src="assets/images/property-04.jpg" alt=""></a>
            <span class="category">Apartment</span>
            <h6>$584.500</h6>
            <h4><a href="index.php?enviar=detalles">12 New Street Miami, OR 12650</a></h4>
            <ul>
