<div class="page-heading header-text">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <span class="breadcrumb"><a href="#">Home</a>  /  contactanos</span>
          <h3>contactanos </h3>
        </div>
      </div>
    </div>
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="item phone">
                ...
                <h6><a href="whatsapp">"https://wa.me/573017945920"</a><br><span>whatsapp Number</span></h6>
              </div>
            </div>
            <div class="col-lg-12">
              <div class="item email">
                <img src="assets/images/email-icon.png" alt="" style="max-width: 52px;">
                <h6>gerencia@grupo-‐exito.com<br><span>Business Email</span></h6>
              </div>
            </div>
          </div>
        </div>
